...
(function (factory) {
    ...
    // fileinput helper object for all global variables and internal helper
	// methods
    // noinspection JSUnresolvedVariable
    $h = {
            ...
            while (i < len) {
                ...
                switch (c >> 4) { // jshint ignore:line
                    ...
                    case 13:
                        // 110x xxxx 10xx xxxx
                        char2 = array[i++];
                        out += String.fromCharCode(((c & 0x1F) << 6) | (char2 & 0x3F)); // jshint
																						// ignore:line
                        break;
                    case 14:
        ...
        validateOrientation: function (file, callback) {
            if (!window.FileReader || !window.DataView) {
                return; // skip orientation if pre-requisite libraries not
    ...
    FileInput.prototype = {
        ...
        _clearFileInput: function () {
            ...
            // Fix for IE ver < 11, that does not clear file inputs. Requires a
			// sequence of steps to prevent IE
        ...
        _change: function (e) {
            ...
            if (!self.isAjaxUpload && $h.isEmpty($el.val()) && self.fileInputCleared) { // IE
																						// 11
																						// fix
                self.fileInputCleared = false;
                return;
            ...
            readFile = function (i) {
                ...
                if ($preview.length && FileReader !== undefined) {
                    ...
                    reader.onload = function (theFile) {
                        ...
                        if (knownTypes === 0) {// auto detect mime types from
												// content if no known file
												// types detected
                            ...
                            if ($h.isEmpty(mime)) { // look for ascii text
													// content
